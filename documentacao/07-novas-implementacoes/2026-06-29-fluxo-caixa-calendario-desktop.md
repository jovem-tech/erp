...
- os badges de entrada e saida no calendario agora ocultam valores zero, e dias sem lancamentos exibem um badge cinza "Sem lancamentos";
- a visualizacao em lista ganhou cor de fonte por tipo: entradas em verde, saidas em vermelho e saldo realizado em azul, sem badges;
