# Tarefas: revisão e salvamento atômico da Nova OS mobile

- [x] T001 Mapear o wizard, payload e geração atual de PDF.
- [x] T002 Adicionar ações locais de edição ao cliente e equipamento.
...
- [x] T010 Aplicar atualizações de cadastros na transação final da OS.
