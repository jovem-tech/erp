    ...
    return (
      <main className="auth-screen">
        <section className="surface auth-card">
          ...
          <p className="auth-card__text">Estamos validando seu acesso à Central de Atendimento.</p>
    ...
    return (
      <main className="auth-screen">
        <section className="surface auth-card">
          ...
          <p className="auth-card__text">Sua sessão não está mais disponível ou expirou.</p>
        </section>
      </main>
    );
  }
