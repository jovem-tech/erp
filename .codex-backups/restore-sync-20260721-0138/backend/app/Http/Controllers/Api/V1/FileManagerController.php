...
class FileManagerController extends BaseApiController
{
    ...
    public function dashboard(Request $request): JsonResponse
    {
        ...
        return $this->success([
            'totals' => [
                ...
                'integrity_issues' => $availableFiles()->whereIn('integrity_status', [FileIntegrityStatus::Missing->value, FileIntegrityStatus::Corrupted->value])->count(),
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        if (! isset($validated['lifecycle_status']) || $validated['lifecycle_status'] === '') {
