...
class DocumentoFiscalService
{
    public function __construct(
        private readonly DiscriminacaoNfseBuilder $discriminacaoBuilder,
    ) {
    }
     ...
     *
     * Delegado ao DiscriminacaoNfseBuilder — único ponto que monta esse texto,
     * pra baixa da OS (rascunho, garantia ainda não escolhida) e documento
     * fiscal (aqui, garantia já gravada) nunca divergirem sobre o que a nota
     * diz. O VALOR da peça fica de fora dele e da soma tributada da NFS-e —
    ...
    {
        return $this->discriminacaoBuilder->montar($order);
    }
