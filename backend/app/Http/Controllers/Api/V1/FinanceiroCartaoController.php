...
class FinanceiroCartaoController extends BaseApiController
{
    ...
    private function serializeTaxa(FinanceiroCartaoTaxa $taxa): array
    {
        return [
            ...
            'taxa_minima' => $taxa->taxa_minima !== null ? round((float) $taxa->taxa_minima, 2) : null,
            'taxa_teto' => $taxa->taxa_teto !== null ? round((float) $taxa->taxa_teto, 2) : null,
    ...
    private function validateGatewayTaxa(Request $request): array
    {
        ...
        $validated = $request->validate([
            ...
            // Vazio significa "sem limite", nao zero.
            'taxa_minima' => ['nullable', 'numeric', 'min:0'],
            'taxa_teto' => ['nullable', 'numeric', 'min:0'],
            'ordem_exibicao' => ['nullable', 'integer', 'min:0'],
    ...
    private function gatewayTaxaPayload(array $validated, ?int $id, Request $request): array
    {
        return [
            ...
            'taxa_minima' => $validated['taxa_minima'] ?? null,
            'taxa_teto' => $validated['taxa_teto'] ?? null,
