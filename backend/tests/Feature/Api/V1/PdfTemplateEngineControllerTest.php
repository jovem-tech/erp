...
class PdfTemplateEngineControllerTest extends TestCase
{
    ...
    public function test_types_endpoint_lists_registered_types_with_published_versions(): void
    {
        ...
        // 7 documentos de OS + a ordem de serviço completa (botão Imprimir da
        // tela da OS) + comprovante de venda (specs/027) + fechamento de caixa
        // (specs/028) + comprovante de devolução (specs/029), todos também
        // editáveis nesta tela.
        $response->assertOk()->assertJsonCount(11, 'data.tipos');
