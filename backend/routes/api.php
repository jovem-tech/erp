...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        ...
        Route::get('files/{fileUuid}/thumbnail', [FileManagerController::class, 'thumbnail'])
            ->middleware('throttle:120,1')
            ->name('api.v1.files.thumbnail');
        Route::post('files/{fileUuid}/archive', [FileManagerController::class, 'archive'])->name('api.v1.files.archive');
        ...
        Route::get('orders/checklists/entrada/modelos/{tipoEquipamento}', [OrderController::class, 'entryChecklistModel'])
        ...
        Route::get('fiscal/ambiente', [DocumentoFiscalController::class, 'ambienteFiscal'])->name('api.v1.fiscal.ambiente');
        Route::post('fiscal/ambiente', [DocumentoFiscalController::class, 'alterarAmbienteFiscal'])->name('api.v1.fiscal.ambiente.alterar');
