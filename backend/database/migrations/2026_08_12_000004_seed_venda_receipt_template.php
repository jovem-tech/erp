...
/**
 * Semeia a v1 publicada do comprovante de venda de balcão (80 mm).
 *
 * Molde: 2026_07_18_000011_seed_pdf_default_templates.php. Idempotente — só
 * cria se o tipo_codigo ainda não existir, para nunca sobrescrever edições
 * feitas na tela Modelos PDF. Ver specs/027-vendas-balcao-pdv/spec.md.
 */
return new class extends Migration
{
    private const TIPO_CODIGO = 'venda_comprovante';
    ...
    public function down(): void
    {
        ...
        // que alguém editou o modelo na tela e isso não pode ser descartado.
