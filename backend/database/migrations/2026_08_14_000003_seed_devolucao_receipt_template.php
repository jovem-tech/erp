...
/**
 * Semeia a v1 publicada do comprovante de devolução (80 mm).
 *
 * Idempotente: só cria se o tipo_codigo ainda não existir.
 * Ver specs/029-devolucao-troca/spec.md.
 */
return new class extends Migration
{
    private const TIPO_CODIGO = 'venda_devolucao';
