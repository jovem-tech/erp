...
- **Tier:** minor
- **Autor/Agente:** Claude
- **Descrição:** Padrao unico de insercao de imagem em todo o sistema (specs/049): Camera (webcam em modal com capturas seguidas e troca de camera; no celular, a camera nativa), Computador/galeria, Colar (botao e Ctrl+V fora de campo de texto, com roteamento: campo unico cola de qualquer lugar, varios -> o do foco/usado por ultimo, modal -> o do modal, ambiguo -> avisa), arrastar e recorte OPCIONAL em toda imagem (girar/ampliar/restaurar, Cropper.js carregado sob demanda; decisao do usuario: nunca forcado). Biblioteca comum window.ErpImagePicker (image-picker.js, global no layout) + componentes <x-image-picker.field|queue|buttons|dropzone> + perfis de destino App\Support\ImagePicker. Migrados: detalhe da OS (fila com Enviar), Nova/Editar OS e equipamento (sai o recorte obrigatorio e os modais proprios), foto de perfil (previa no circulo + Salvar foto, recorte quadrado), assinatura por arquivo (PNG ate 2 MB), logo e fundo do login (logo PNG transparente preservada; ajuda deixava de prometer GIF/SVG), anexos do financeiro (cadastro, detalhe e listagem, com PDF). Mobile: PhotoPicker ganha Camera, arrastar e recorte (cropperjs 1.6.2 via pnpm, chunk de 37 KB sob demanda). Rotas do backend inalteradas (campo de formulario via DataTransfer). Trava: ImageInsertionStandardTest falha com input de imagem fora do padrao; regra no AGENTS.md e skill sistema-erp-insercao-de-imagem.
- **Arquivos:** frontends/desktop/public/assets/js/image-picker.js,frontends/desktop/app/Support/ImagePicker.php,frontends/desktop/resources/views/components/image-picker/field.blade.php,frontends/desktop/resources/views/components/image-picker/buttons.blade.php,frontends/desktop/resources/views/components/image-picker/dropzone.blade.php,frontends/desktop/resources/views/components/image-picker/queue.blade.php,frontends/desktop/resources/views/layouts/app.blade.php,frontends/desktop/public/assets/css/desktop.css,frontends/desktop/resources/views/orders/show.blade.php,frontends/desktop/resources/views/orders/_wizard.blade.php,frontends/desktop/resources/views/orders/_wizard_scripts.blade.php,frontends/desktop/resources/views/orders/create.blade.php,frontends/desktop/resources/views/orders/edit.blade.php,frontends/desktop/resources/views/orders/_photo_crop_modal.blade.php,frontends/desktop/public/assets/js/orders-create.js,frontends/desktop/resources/views/equipments/create.blade.php,frontends/desktop/public/assets/js/equipments-create.js,frontends/desktop/resources/views/profile/edit.blade.php,frontends/desktop/public/assets/js/profile-photo.js,frontends/desktop/public/assets/js/profile-signature.js,frontends/desktop/resources/views/configurations/system.blade.php,frontends/desktop/resources/views/financeiro/form.blade.php,frontends/desktop/resources/views/financeiro/show.blade.php,frontends/desktop/resources/views/financeiro/_quick_anexo_modal.blade.php,frontends/desktop/tests/Feature/Desktop/ImageInsertionStandardTest.php,frontends/desktop/tests/Feature/Desktop/ImagePickerScreensTest.php,frontends/desktop/tests/Feature/Desktop/OrderPhotoUploadTest.php,frontends/desktop/tests/Feature/Desktop/DesktopFrontendTest.php,frontends/desktop/tests/Feature/Desktop/FinanceiroAnexoTest.php,frontends/mobile/src/components/orders/order-form-wizard/photo-picker.tsx,frontends/mobile/src/components/orders/order-form-wizard/photo-crop-dialog.tsx,frontends/mobile/src/components/orders/order-form-wizard/__tests__/photo-picker.test.tsx,frontends/mobile/src/components/orders/order-form-wizard/__tests__/photo-crop-dialog.test.tsx,frontends/mobile/src/app/globals.css,frontends/mobile/package.json,frontends/mobile/pnpm-lock.yaml,AGENTS.md,.agents/skills/sistema-erp-insercao-de-imagem/SKILL.md,specs/049-padrao-insercao-imagem/spec.md,specs/049-padrao-insercao-imagem/plan.md,specs/049-padrao-insercao-imagem/tasks.md,documentacao/07-novas-implementacoes/2026-09-26-padrao-insercao-imagem.md,documentacao/README.md

## v6.4.0.0 — 2026-09-25 22:34
- **Tier:** minor
- **Autor/Agente:** Claude
- **Descrição:** Fotos direto na visualizacao da OS (specs/048): o quadro Fotos do detalhe ganha Camera (webcam em modal com capturas seguidas e troca de camera; no celular, a camera nativa), Computador/galeria, Colar (botao e Ctrl+V em qualquer ponto da pagina fora de campo de texto, inclusive print e arquivo copiado no Explorador) e arrastar. Tudo entra numa fila com miniatura e remover; nada e' gravado antes do Enviar (nao existe exclusao de foto de OS). Categoria Recepcao/Diagnostico/Entrega sugerida pela fase do status (antes toda foto era recepcao). Envio em lotes de 4 com progresso, galeria redesenhada sem recarregar (parcial Blade unico) e fotos novas destacadas; falha num lote mantem o restante na fila. Fotos grandes reduzidas no navegador para 2560 px (11 MB -> ~3 MB) so como economia de trafego. Sem etapa de recorte. Backend: POST /api/v1/orders/{order}/photos (os:editar, escopo do tecnico, throttle de fotos, OperationalPhotoUpload) e evento fotos_adicionadas com usuario e categoria. Desktop: POST /os/{order}/fotos (JSON com a galeria renderizada ou redirect), mensagem de campo do backend em vez do generico e 504 avisando que o upload pode ter sido gravado. Busca de funcionalidades: 'Adicionar fotos a OS'.
- **Arquivos:** backend/app/Models/OrderPhoto.php,backend/app/Http/Requests/Api/V1/StoreOrderPhotosRequest.php,backend/app/Http/Controllers/Api/V1/OrderController.php,backend/app/Services/Orders/OrderWorkflowService.php,backend/routes/api.php,backend/openapi.yaml,backend/tests/Feature/Api/V1/OrderPhotoUploadTest.php,frontends/desktop/routes/web.php,frontends/desktop/app/Services/OrderService.php,frontends/desktop/app/Http/Controllers/OrderController.php,frontends/desktop/app/Support/OrderPhotoTypes.php,frontends/desktop/app/Support/DesktopFeatureCatalog.php,frontends/desktop/resources/views/orders/show.blade.php,frontends/desktop/resources/views/orders/_photos_gallery.blade.php,frontends/desktop/resources/views/orders/_photo_camera_modal.blade.php,frontends/desktop/public/assets/js/orders-photo-upload.js,frontends/desktop/public/assets/css/desktop.css,frontends/desktop/tests/Feature/Desktop/OrderPhotoUploadTest.php,specs/048-fotos-na-visualizacao-da-os/spec.md,specs/048-fotos-na-visualizacao-da-os/plan.md,specs/048-fotos-na-visualizacao-da-os/tasks.md,documentacao/07-novas-implementacoes/2026-09-25-fotos-na-visualizacao-da-os.md,documentacao/README.md
...
- **Tier:** minor
- **Autor/Agente:** Claude
- **Descrição:** Documentos PDF da OS e orcamento renderizados sob demanda a partir de snapshot por versao; binario em disco so para assinatura formal; TODO PDF gerado (persistido ou efemero) respeita teto de 80 KB via subsetting de fonte, fotos/logo via libvips e Ghostscript escalonado (achado: gs roda sob AppArmor no Ubuntu, so grava em /tmp); comandos de purga do passivo, cache de render e diagnostico
- **Arquivos:** backend/app/Console/Commands/Documents/PurgeLegacyDocumentBinaries.php,backend/app/Console/Commands/Documents/PurgeRenderCache.php,backend/app/Console/Commands/Documents/SnapshotCheck.php,backend/app/Http/Controllers/Api/V1/OrderController.php,backend/app/Http/Controllers/Api/V1/PublicDocumentSignatureController.php,backend/app/Http/Controllers/Web/BudgetPublicController.php,backend/app/Http/Controllers/Web/OrderDocumentPublicController.php,backend/app/Models/OrderDocument.php,backend/app/Models/OrderDocumentSnapshot.php,backend/app/Observers/OrderDocumentFileObserver.php,backend/app/Services/Budgets/BudgetApprovalService.php,backend/app/Services/Budgets/BudgetPdfService.php,backend/app/Services/Files/ManagedFilePurgeService.php,backend/app/Services/Files/PdfThumbnailRasterizer.php,backend/app/Services/Files/PdfThumbnailService.php,backend/app/Services/Integrations/IntegrationSettingsService.php,backend/app/Services/Orders/Documents/DocumentBytesResolver.php,backend/app/Services/Orders/Documents/DocumentPersistencePolicy.php,backend/app/Services/Orders/Documents/OrderDocumentThumbnailService.php,backend/app/Services/Orders/Documents/OrderDocumentVersionWriter.php,backend/app/Services/Orders/Documents/PdfRenderCache.php,backend/app/Services/Orders/Documents/ResolvedDocumentFile.php,backend/app/Services/Orders/OrderClosurePdfService.php,backend/app/Services/Orders/OrderDocumentCenterService.php,backend/app/Services/Orders/OrderOpeningPdfService.php,backend/app/Services/Orders/OrderWorkflowService.php,backend/app/Services/Pdf/Contexts/BudgetPdfContextFactory.php,backend/app/Services/Pdf/Contexts/CompanyContextProvider.php,backend/app/Services/Pdf/Contexts/OrderPdfContextFactory.php,backend/app/Services/Pdf/PdfCompressionService.php,backend/app/Services/Pdf/PdfGenerationService.php,backend/app/Services/Pdf/Snapshots/DocumentSnapshotHydrator.php,backend/app/Services/Pdf/Snapshots/DocumentSnapshotSerializer.php,backend/app/Services/Photos/OperationalPhotoPdfRenderer.php,backend/app/Services/Photos/VipsCommandRunner.php,backend/config/document-rendering.php,backend/config/filesystems.php,backend/database/migrations/2026_09_15_000001_create_os_documento_snapshots_table.php,backend/.env.example,backend/phpunit.xml,backend/resources/views/pdf-engine/blocks/fotos-entrada.blade.php,backend/resources/views/pdf-engine/document.blade.php,backend/routes/console.php,backend/tests/Concerns/BuildsLegacyErpSchema.php,backend/tests/Feature/Api/V1/BudgetFlowTest.php,backend/tests/Feature/Api/V1/OrderDocumentSnapshotTest.php,backend/tests/Feature/Api/V1/PdfEngineGuardTest.php,backend/tests/Feature/Console/PurgeLegacyDocumentBinariesTest.php,backend/tests/Feature/Console/PurgeRenderCacheTest.php,backend/tests/Unit/Services/Pdf/DocumentSnapshotSerializerTest.php,backend/tests/Unit/Services/Pdf/PdfCompressionServiceTest.php,documentacao/02-infraestrutura-ambientes/ambiente-dev-linux-bancada.md,documentacao/07-novas-implementacoes/2026-09-15-documentos-pdf-sob-demanda.md,documentacao/10-deploy/deploy-producao-contabo-vps.md,documentacao/10-deploy/deploy-producao-lan-ubuntu.md,documentacao/10-deploy/operacao-documentos-sob-demanda.md,documentacao/10-deploy/README.md,scripts/bash/install-operational-photo-dependencies.sh,specs/047-documentos-pdf-sob-demanda/plan.md,specs/047-documentos-pdf-sob-demanda/spec.md,specs/047-documentos-pdf-sob-demanda/tasks.md
...
- **Tier:** minor
- **Autor/Agente:** Codex
- **Descrição:** Fotos operacionais centralizadas em AVIF com meta de 400 KB, teto de 700 KB e suporte HEIC de iPhone
- **Arquivos:** backend/app/Services/Photos,backend/app/Services/EquipmentWorkflowService.php,backend/app/Services/Orders/OrderWorkflowService.php,frontends/desktop,frontends/mobile,backend/openapi.yaml,specs/046-otimizacao-fotos-operacionais

## v5.86.1.0 — 2026-09-11 15:44
- **Tier:** patch
- **Autor/Agente:** Codex
- **Descrição:** Visualização da OS passa a listar as NFS-e emitidas e canceladas vinculadas, com arquivos e autorização fiscal
- **Arquivos:** frontends/desktop/app/Http/Controllers/OrderController.php,frontends/desktop/resources/views/orders/show.blade.php,frontends/desktop/resources/views/orders/_fiscal_documents.blade.php,frontends/desktop/tests/Feature/Desktop/DocumentoFiscalTest.php,specs/041-emissao-fiscal-nfse/tasks.md,documentacao/07-novas-implementacoes/2026-09-11-nfse-na-visualizacao-os.md

## v5.86.0.1 — 2026-09-11 15:36
- **Tier:** hotfix
- **Autor/Agente:** Codex
- **Descrição:** Corrige o aviso da baixa: NFS-e pode ser emitida sem identificar o tomador, mantendo a preferência pelo cadastro
- **Arquivos:** frontends/desktop/resources/views/orders/closure.blade.php,frontends/desktop/tests/Feature/Desktop/DocumentoFiscalTest.php

## v5.86.0.0 — 2026-09-11 14:37
- **Tier:** minor
- **Autor/Agente:** Codex
- **Descrição:** Integra anexos financeiros ao Gerenciador de Arquivos com ciclo de vida unificado e reconciliação segura
- **Arquivos:** backend/.env.example,backend/.env.production.example,backend/app/Console/Commands/Files/ReconcileFinanceiroAnexos.php,backend/app/Http/Controllers/Api/V1/FileManagerController.php,backend/app/Http/Controllers/Api/V1/FinanceiroAnexoController.php,backend/app/Http/Controllers/Api/V1/FinanceiroController.php,backend/app/Models/FinanceiroAnexo.php,backend/app/Observers/FinanceiroAnexoObserver.php,backend/app/Services/Files/AutomaticFileSyncService.php,backend/app/Services/Files/Authorizers/FinanceiroFileAuthorizer.php,backend/app/Services/Files/DomainFileLinkReconciliationService.php,backend/app/Services/Files/FileManagerConfiguration.php,backend/app/Services/Files/FilePathGuard.php,backend/app/Services/Files/FileStateMachine.php,backend/app/Services/Files/FinanceiroAnexoCatalogService.php,backend/app/Services/Files/FinanceiroAnexoReconciliationService.php,backend/app/Services/Files/LegacyFileCatalogService.php,backend/app/Services/Files/ManagedFileDomainLifecycleService.php,backend/app/Services/Files/ManagedFilePurgeService.php,backend/app/Services/Financeiro/FinanceiroAnexoService.php,backend/app/Services/Financeiro/FinanceiroService.php,backend/config/file-manager.php,backend/database/migrations/2026_09_11_000002_integrate_financeiro_anexos_with_file_manager.php,backend/openapi.yaml,backend/tests/Feature/Api/V1/FinanceiroAnexoTest.php,backend/tests/Feature/Files/FileManagerApiTest.php,frontends/desktop/app/Http/Controllers/FinanceiroAnexoController.php,frontends/desktop/public/assets/js/financeiro-anexos.js,frontends/desktop/resources/views/financeiro/show.blade.php,frontends/desktop/tests/Feature/Desktop/FinanceiroAnexoTest.php,documentacao/07-novas-implementacoes/2026-09-11-anexos-financeiros-gerenciador-arquivos.md

## v5.85.1.0 — 2026-09-11 08:46
- **Tier:** patch
- **Autor/Agente:** Codex
- **Descrição:** Ajuda do catalogo de equipamentos ganha um prompt pronto para revisar o CSV exportado com uma IA externa (Claude, ChatGPT etc.), com botao Copiar. Pedido explicito do dono do sistema: as instrucoes de como pedir pra IA padronizar nomes de modelo e preencher mesclar_com_id nos duplicados precisavam estar dentro do proprio sistema, nao so numa conversa avulsa. O prompt explica as regras reais da importacao (nao mexer em id/tipo/marca, so mesclar dentro da mesma marca, nao mesclar em cadeia, manter cabecalho e delimitador) pra o resultado da IA voltar pronto pra reimportar sem gerar erro. Texto fica no controller (aiReviewPrompt(), heredoc) pra nao poluir a view; textarea readonly + botao com fallback document.execCommand('copy') pro navigator.clipboard, mesmo padrao ja usado em orders-closure.js (a oficina acessa por IP em rede local, onde clipboard API nem sempre existe). Teste novo cobrindo a pagina de ajuda.
- **Arquivos:** frontends/desktop/app/Http/Controllers/EquipmentCatalogController.php,frontends/desktop/resources/views/equipments/catalog/help.blade.php,frontends/desktop/tests/Feature/Desktop/EquipmentCatalogTest.php

## v5.85.0.1 — 2026-09-11 05:15
- **Tier:** hotfix
- **Autor/Agente:** Codex
- **Descrição:** Corrige tela Equipamentos > Catalogo travada em Carregando pagina ao clicar Exportar CSV ou Modelo CSV. O overlay global de transicao de pagina (desktop.js shouldHandleLinkNavigation/hidePageLoader) so se esconde nos eventos pageshow/pagehide, que so disparam numa navegacao de verdade — um link que so baixa um arquivo (Content-Disposition: attachment) nao navega, entao o overlay ficava preso pra sempre. Os dois links ja tinham o mecanismo de opt-out pronto no proprio desktop.js (data-no-page-loader), so faltava usa-lo nesta tela nova; adicionado aos links Exportar CSV e Modelo CSV do catalogo de equipamentos, com teste de regressao. Mesmo bug provavelmente afeta os links equivalentes de Servicos e Estoque (nao tem o atributo la' tambem) — fora do escopo desta correcao pontual, fica registrado para quem for mexer la'.
- **Arquivos:** frontends/desktop/resources/views/equipments/catalog/index.blade.php,frontends/desktop/tests/Feature/Desktop/EquipmentCatalogTest.php

## v5.85.0.0 — 2026-09-11 05:07
- **Tier:** minor
- **Autor/Agente:** Codex
- **Descrição:** Catalogo de equipamentos: edicao em massa por ID e mesclagem de duplicados (specs/045, base specs/044). A 044 resolvia adicionar/atualizar modelos por nome, mas nao ajudava a CORRIGIR os 1964 modelos ja cadastrados, muitos incompletos/ambiguos, alguns duplicados (o mesmo aparelho registrado como Samsung-J7, Samsung-j 7 e Samsung-SM-J730G). Mesmo CSV de sempre ganhou duas colunas OPCIONAIS (arquivo sem elas continua identico a antes): id (mira o registro exato, deixa de casar por nome — permite exportar, corrigir/padronizar nomes numa planilha com ou sem apoio de IA externa, e reimportar) e mesclar_com_id (funde o modelo da linha no id informado — precisa ser da mesma marca e alvo ativo; todo aparelho e orcamento que apontava pro perdedor passa a apontar pro vencedor, relacao de catalogo migrada via ensureCatalogRelationRecord ja existente — evita violar a unique key (tipo_id,marca_id,modelo_id) quando o vencedor ja cobre o mesmo tipo — e o perdedor e desativado, nunca excluido, porque 3618 aparelhos apontam pro catalogo por FK). Cadeia de mesclagem no mesmo arquivo (A funde em B que tambem funde em C) e rejeitada; id repetido com dados conflitantes gera erro em vez de deixar a ultima linha decidir em silencio. Fecha de brinde uma lacuna que ja existia desde a 044: os.busca_texto e um snapshot (nao um join ao vivo, unico lugar do sistema com esse problema) e nao tinha observer pra mudanca no catalogo — mesclagem agora chama OrderSearchIndexService::rebuildForEquipment() pra cada aparelho afetado, entao a busca de OS nao fica mostrando o nome do modelo que acabou de ser fundido. Renomear por id sem merge nao dispara isso automaticamente (custaria caro num modelo usado por centenas de aparelhos dentro do proprio upload) — continua exigindo o comando existente php artisan os:reindexar-busca pra lotes grandes. 8 testes novos (6 backend + 2 desktop); verificado tambem contra o banco real de dev (sistema_hml) dentro de uma transacao com rollback forcado, reproduzindo o cenario exato do pedido (dois modelos duplicados reais mesclados num terceiro, aparelho repontado, relacao unica preservada).
- **Arquivos:** backend/app/Services/EquipmentCatalogService.php,backend/app/Http/Controllers/Api/V1/EquipmentCatalogController.php,backend/openapi.yaml,backend/tests/Feature/Api/V1/EquipmentCatalogTest.php,frontends/desktop/resources/views/equipments/catalog/help.blade.php,frontends/desktop/resources/views/equipments/catalog/partials/import-report.blade.php,frontends/desktop/resources/views/equipments/catalog/partials/tab-modelos.blade.php,frontends/desktop/resources/views/equipments/catalog/partials/tab-marcas.blade.php,frontends/desktop/tests/Feature/Desktop/EquipmentCatalogTest.php,specs/045-catalogo-equipamentos-edicao-massa-mesclagem/spec.md,specs/045-catalogo-equipamentos-edicao-massa-mesclagem/tasks.md,documentacao/07-novas-implementacoes/2026-09-11-catalogo-equipamentos-edicao-massa-mesclagem.md

## v5.84.0.0 — 2026-09-11 04:02
- **Tier:** minor
- **Autor/Agente:** Codex
- **Descrição:** Catalogo de equipamentos (tipos/marcas/modelos) com importacao CSV (specs/044). Nao existia tela nenhuma para administrar o catalogo relacional que a OS e o orcamento ja consultavam desde a vinculacao rapida de 2026-06-25 (equipamentos_tipos/marcas/modelos/catalogo_relacoes) — a unica forma de cadastrar marca/modelo era o quick-add no meio do cadastro de um aparelho, um de cada vez, sem lugar pra ver a lista inteira ou corrigir um nome digitado errado. Novo menu Equipamentos em Cadastros, tres abas (Modelos/Marcas/Tipos) sobre o MESMO catalogo — nenhuma tabela nova, nenhuma migration, nenhuma mudanca de RBAC. Novo/renomear/ativar-desativar em cada aba, nunca exclusao real (3618 aparelhos apontam pro catalogo por FK). Importacao CSV (tipo;marca;modelo;ativo) e upsert aditivo: casa por nome ignorando maiusculas, cria o que falta, reativa o que estava inativo e ATUALIZA O CASING PRO DO ARQUIVO (CSV e a fonte curada) — nunca desativa o que ficou fora do arquivo, so ativo=0 explicito na linha desativa. Tipo desconhecido rejeita so a linha (com motivo no relatorio), nunca cria tipo novo (sao so 12, compartilhados com Estoque/Servicos/Checklists/Base de defeitos). EquipmentCatalogService no backend nasceu como extracao dos helpers de escopo tipo-marca-modelo que ja existiam em EquipmentWorkflowService (ensureBrandTypeCatalogScope/ensureModelTypeCatalogScope/ensureCatalogRelationRecord/ensureBrandScopeAnchorModel), agora publicos e reaproveitados por createBrand/createModel via delegacao — comportamento identico, coberto por EquipmentCreationTest. Sem mudanca nenhuma em OS/orcamento/mobile: continuam lendo GET equipments/form-data como sempre.
- **Arquivos:** backend/app/Services/EquipmentCatalogService.php,backend/app/Services/EquipmentWorkflowService.php,backend/app/Http/Controllers/Api/V1/EquipmentCatalogController.php,backend/routes/api.php,backend/openapi.yaml,backend/tests/Feature/Api/V1/EquipmentCatalogTest.php,frontends/desktop/app/Services/EquipmentCatalogService.php,frontends/desktop/app/Http/Controllers/EquipmentCatalogController.php,frontends/desktop/app/Support/DesktopNavigation.php,frontends/desktop/routes/web.php,frontends/desktop/resources/views/equipments/catalog/index.blade.php,frontends/desktop/resources/views/equipments/catalog/help.blade.php,frontends/desktop/resources/views/equipments/catalog/partials/tab-modelos.blade.php,frontends/desktop/resources/views/equipments/catalog/partials/tab-marcas.blade.php,frontends/desktop/resources/views/equipments/catalog/partials/tab-tipos.blade.php,frontends/desktop/resources/views/equipments/catalog/partials/modals.blade.php,frontends/desktop/resources/views/equipments/catalog/partials/import-report.blade.php,frontends/desktop/public/assets/js/equipments-catalog.js,frontends/desktop/tests/Feature/Desktop/EquipmentCatalogTest.php,specs/044-catalogo-equipamentos-csv/spec.md,specs/044-catalogo-equipamentos-csv/tasks.md,documentacao/07-novas-implementacoes/2026-09-11-catalogo-equipamentos-tipos-marcas-modelos-csv.md

## v5.83.0.0 — 2026-09-10 08:42
- **Tier:** minor
- **Autor/Agente:** Codex
- **Descrição:** Reserva de peca de estoque vinculada ao orcamento (specs/040). orcamento_itens apontava para pecas por tipo_item+referencia_id SEM FK e SEM validacao de saldo: dois orcamentos podiam prometer a mesma peca unica e ninguem descobria ate o tecnico abrir a gaveta; e o seletor de peca era um catalogo estatico de 80 itens que RECEBIA quantidade_atual do backend e o DESCARTAVA no mapeamento, entao quem orcava nao via estoque nenhum. Agora a peca de um orcamento ENVIADO ao cliente fica reservada para aquele orcamento/equipamento e some do disponivel de todos os outros caminhos (PDV, baixa de OS, outros orcamentos), voltando ao estoque na rejeicao, cancelamento, vencimento (app:expire-budgets ja roda hourly) ou liberacao manual. Tabela estoque_reservas e a verdade (reserva tem ciclo de vida, vencimento e dono, e movimentacoes e imutavel por design); pecas.quantidade_reservada e so o cache do somatorio, reescrito por SOMA ABSOLUTA dentro do lockForUpdate da linha de pecas — auto-reparavel, ao contrario de delta. A reserva e chaveada por (orcamento_id, peca_id) e nunca por id de item, porque syncItems() apaga e reinsere todos os itens a cada save. Em vez de espalhar reservar()/liberar() pelos OITO pontos de transicao, EstoqueReservaService::sincronizar() reconcilia o estado desejado a partir de (status, itens). Disponivel = saldo - reservado + reserva DO PROPRIO orcamento: sem o ultimo termo a reserva bloquearia justamente a baixa que ela protegia. Dois furos criticos de escrita fechados: update() passa a RECUSAR quantidade_atual com 422 (matando de quebra o bug de um PATCH que apenas OMITISSE o campo zerar o saldo em silencio, escondido porque o formulario do desktop sempre enviava) e storeMovement() roteia entrada/saida pelo motor unico, eliminando o read-modify-write sem lock que truncava em zero. Telas: badge Em estoque/Parcial/A encomendar no orcamento, busca remota paginada de peca substituindo o catalogo de 80 (com fallback automatico), tela Pecas a comprar consolidando a falta de todos os orcamentos com link para a entrada por compra da 039, e colunas Reservado/Disponivel no estoque. Aceite duro cumprido: SaleFlowTest e SaleReturnFlowTest passam sem uma linha alterada. 30 testes novos (15+7 no backend, 3 na baixa da OS, 5 no desktop); backend 1282 passando. PENDENTE: teste de concorrencia no grupo mysql (lockForUpdate e no-op em SQLite).
- **Arquivos:** backend/database/migrations/2026_09_10_000001_create_estoque_reservas_table.php,backend/database/migrations/2026_09_10_000002_add_quantidade_reservada_to_pecas.php,backend/app/Models/EstoqueReserva.php,backend/app/Models/Peca.php,backend/app/Services/Estoque/EstoqueReservaService.php,backend/app/Services/Estoque/EstoqueMovimentacaoService.php,backend/app/Services/Estoque/OsAplicacaoPecaService.php,backend/app/Services/Sales/SaleStockService.php,backend/app/Services/Budgets/BudgetApprovalService.php,backend/app/Services/Budgets/BudgetWorkflowService.php,backend/app/Services/Orders/OrderWorkflowService.php,backend/app/Http/Controllers/Api/V1/EstoqueController.php,backend/routes/api.php,backend/openapi.yaml,frontends/desktop/app/Http/Controllers/OrcamentoController.php,frontends/desktop/app/Http/Controllers/StockController.php,frontends/desktop/app/Services/StockService.php,frontends/desktop/routes/web.php,frontends/desktop/resources/views/estoque/a-comprar.blade.php,frontends/desktop/resources/views/estoque/index.blade.php,frontends/desktop/resources/views/estoque/form.blade.php,frontends/desktop/resources/views/orcamentos/show.blade.php,frontends/desktop/resources/views/orcamentos/partials/item-row.blade.php,frontends/desktop/public/assets/js/orcamentos-form.js
...
## v5.82.1.0 — 2026-09-10 03:50
- **Tier:** patch
- **Autor/Agente:** Codex
- **Descrição:** Repasse e taxa de cartao passam a ser datados pelo dia do PAGAMENTO, e nao pelo dia em que a baixa foi digitada, com rolagem para o proximo dia util. Cenario real: OS entregue e paga no sabado 29/08/2026, baixa lancada na segunda 31/08, operadora em D+1 — o repasse previsto e a taxa sairam em 01/09 (31/08 + 1) em vez de 31/08 (29/08 + 1, rolado do domingo). FinanceiroCartaoService::simulate() ancorava o prazo em Carbon::now(); agora resolve a data base do payload (data_base/data_pagamento/data_movimento, hoje so como fallback da simulacao da tela) e o novo creditDate() rola sabado/domingo para segunda — adquirente nao liquida em fim de semana; feriado fica de fora de proposito (nao existe calendario no sistema, e data_credito_efetivo da conciliacao sobrepoe a previsao). Os tres caminhos que simulavam com now() passaram a informar a data real: baixa/adiantamento de OS (OrderClosureService::simulateCardPayments, com dataReferencia igual a de processReceipts), baixa avulsa em cartao (FinanceiroService, data do movimento) e venda do PDV (SalePaymentService, data_pagamento ja resolvida por normalizePayments). Dois furos vizinhos no mesmo caminho, achados na reproducao: a taxa da baixa de OS nascia sem data_competencia e, pelo fallback de Financeiro::scopeCompetenciaEntre para data_vencimento, era reconhecida no mes do repasse — agosto ficava com a receita bruta e setembro com o custo da maquininha; e financeiro_movimentos_cartao.data_competencia gravava NULO quando a tela nao mandava data_pagamento por recebimento, enquanto o movimento ia datado pela data de entrega. Endpoint POST /financeiro/cartoes/simular aceita data_pagamento opcional. Dois testes de fluxo de caixa que derivavam o repasse com now()->addDays(30) foram travados no relogio e passaram a fixar a regra do dia util.
- **Arquivos:** backend/app/Services/Financeiro/FinanceiroCartaoService.php,backend/app/Services/Orders/OrderClosureService.php,backend/app/Services/Financeiro/FinanceiroService.php,backend/app/Services/Sales/SalePaymentService.php,backend/app/Http/Controllers/Api/V1/FinanceiroCartaoController.php,backend/tests/Feature/Api/V1/OrderFlowTest.php,backend/tests/Feature/Api/V1/FinanceiroCartaoTest.php,backend/tests/Feature/Api/V1/FinanceiroReportTest.php

## v5.82.0.0 — 2026-09-09 22:41
- **Tier:** minor
- **Autor/Agente:** Claude
- **Descrição:** Ambiente de emissao fiscal (homologacao/producao) passa a ser administravel pela tela, em vez de depender so do .env — terminal. Novo servico AmbienteFiscal centraliza a decisao com a mesma precedencia que CertificadoA1::senha() ja usa (banco vence .env, que segue como padrao de instalacao, nascendo em homologacao); AmbienteNacionalClient, DpsXmlBuilder e EmissaoNfseService passam a ler o ambiente daqui em vez de config() direto. Tres guardas porque e' a chave de maior consequencia do modulo fiscal: ligar producao e' recusado se o certificado estiver invalido ou faltar cadastro fiscal da empresa (mesma checagem de EmissaoNfseService::conferirCadastroDaEmpresa, reaproveitada); permissao propria fiscal:administrar (nova, semeada espelhando fiscal:excluir), e nao fiscal:criar nem configuracoes:editar — emitir gera um documento, virar a chave faz toda emissao seguinte valer de verdade para todo mundo; toda troca grava usuario/IP/horario na tabela logs (que passou a existir tambem no schema de teste) e no canal fiscal. Na tela (Configuracoes > Integracoes > Certificado A1): badge vermelho Producao / amarelo Homologacao com o significado escrito por extenso; ligar producao exige digitar PRODUCAO num campo de confirmacao; voltar para homologacao nao pede nada — o caminho de reduzir risco tem de ser o mais facil dos dois. Endpoints novos GET/POST /fiscal/ambiente no backend, espelhados no desktop.
- **Arquivos:** backend/app/Services/Fiscal/AmbienteFiscal.php,backend/app/Http/Controllers/Api/V1/DocumentoFiscalController.php,backend/routes/api.php,backend/database/migrations/2026_09_09_000002_seed_fiscal_administrar_permission.php,backend/tests/Concerns/BuildsLegacyErpSchema.php,backend/tests/Feature/Fiscal/AmbienteFiscalTest.php,backend/tests/Feature/Fiscal/DpsXmlBuilderTest.php,frontends/desktop/app/Http/Controllers/ConfigurationController.php,frontends/desktop/app/Services/DocumentoFiscalService.php,frontends/desktop/resources/views/configurations/integrations.blade.php,frontends/desktop/routes/web.php,frontends/desktop/tests/Feature/Desktop/EmissaoNfseAutomaticaTest.php

## v5.81.1.0 — 2026-09-09 22:40
- **Tier:** patch
- **Autor/Agente:** Claude
- **Descrição:** NOTA DE CORRECAO: o commit 12684d0 (rodado por scripts/bash/deploy-completo.sh) contem as correcoes abaixo mas reaproveitou a mensagem antiga da v5.81.0.0 — mesmo padrao do 4be5141 anterior, agora vindo do proprio tooling de deploy. Oito defeitos encontrados na primeira validacao real da emissao de NFS-e, em cadeia: (1) cadastro fiscal da empresa incompleto queimava nDPS antes de falhar, agora validado antes de alocar; (2) RuntimeException do builder escapava como 500 generico, agora reembalada como NfseException; (3) Id da DPS com codigo IBGE zerado em silencio via str_pad, agora validado; (4) serie 70000 (faixa do Emissor Web/portal) usada por engano em vez de 00001 (aplicativo proprio/API) — revertida, e EmissaoNfseService::conferirFaixaDaSerie() recusa antes de transmitir; (5) AmbienteNacionalClient nao lia Codigo/Descricao maiusculos que o ADN devolve, mensagem de erro virava HTTP 400 sem informacao; (6) AssinaturaXml: dois bugs pre-existentes na assinatura ANINHADA que toda NFS-e do ADN tem (assinatura do contribuinte sobre a DPS + assinatura do ADN sobre a NFS-e que contem a DPS dentro) — a transform enveloped-signature removia TODAS as assinaturas em vez de so' a propria, e o clone via importNode() nao e' fiel para canonicalizacao (232 bytes a mais num XML real); juntos, reprovavam NFS-e legitima e autorizada com 'arquivo alterado depois de assinado' — afeta tambem a importacao manual de XML; prova em tests/Fixtures/nfse/nfse-real-adn-assinada.xml; (7) consulta previa contra duplicidade assumia que GET /dps/{idDps} devolvia o XML, mas o contrato real e' em dois passos (dps devolve so' a chave de acesso; GET /nfse/{chave} devolve o XML) — por isso a consulta nunca funcionava de verdade; (8) rejeicao E0014 (DPS ja existe) era tratada como erro de regra de negocio em vez de recuperacao — EmissaoNfseService::ehDpsJaEmitida() agora consulta e registra a nota existente em vez de marcar rejeitado; e a falta de registro apos autorizacao (achado no meio do processo) deixou de ser silenciosa: XML salvo em storage/app/private/fiscal/recuperacao/, log gritando no canal fiscal, mensagem explicita ao operador. Validado com nota REAL em producao (NFS-e no 6, serie 00001, tomador sem CPF/CNPJ, cancelada no portal do governo com justificativa de implementacao). Testes corrigidos contra o comportamento real do ADN, nao so complementados.
- **Arquivos:** backend/app/Services/Fiscal/AmbienteNacionalClient.php,backend/app/Services/Fiscal/AssinaturaXml.php,backend/app/Services/Fiscal/DpsXmlBuilder.php,backend/app/Services/Fiscal/EmissaoNfseService.php,backend/config/fiscal.php,backend/tests/Feature/Fiscal/AmbienteNacionalClientTest.php,backend/tests/Feature/Fiscal/AssinaturaAninhadaTest.php,backend/tests/Feature/Fiscal/EmissaoNfseServiceTest.php,backend/tests/Fixtures/nfse/ORIGEM.md,backend/tests/Fixtures/nfse/nfse-real-adn-assinada.xml,documentacao/07-novas-implementacoes/2026-09-09-emissao-automatica-nfse-ambiente-nacional.md

## v5.81.0.0 — 2026-09-09 18:01
- **Tier:** minor
- **Autor/Agente:** Claude
- **Descrição:** Emissao automatica de NFS-e pelo Ambiente Nacional (spec 041): transmite a DPS assinada direto ao SEFIN Nacional por mTLS com o certificado A1, sem passar pelo portal do gov.br. NOTA DE CORRECAO: este trabalho foi commitado dentro de 4be5141 ('Documentacao da entrega do Mapa da OS'), junto com uma entrega nao relacionada de outra sessao — a mensagem daquele commit nao descrevia esta parte. AmbienteNacionalClient (cliente mTLS, envio/resposta em gzip+base64, sem retry no POST de emissao), EmissaoNfseService (orquestrador com protecao contra nota duplicada: consulta o ADN antes de reenviar apos falha de transporte), SequenciaDps (numerador do nDPS por serie, com fiscal:sequencia-dps para reposicionar em empresa que ja emitia pelo portal), CertificadoPemTemporario (material TLS em arquivo 0600, apagado no finally). DpsXmlBuilder: tomador deixa de ser obrigatorio — RuntimeException virou omissao do bloco <toma>, provado contra o XSD oficial e contra NFS-e real autorizada sem tomador (tests/Fixtures/nfse/nfse-real-sem-tomador.xml). UI: botao 'Emitir agora pelo sistema' na tela da nota com badge de ambiente (Homologacao/Producao) e aviso explicito quando e' producao real; checkbox do encerramento da OS habilitado, sem bloquear a baixa se a emissao falhar. 233 testes novos/ajustados.
- **Arquivos:** backend/app/Services/Fiscal/AmbienteNacionalClient.php,backend/app/Services/Fiscal/EmissaoNfseService.php,backend/app/Services/Fiscal/SequenciaDps.php,backend/app/Services/Fiscal/CertificadoPemTemporario.php,backend/app/Services/Fiscal/NfseException.php,backend/app/Services/Fiscal/DpsXmlBuilder.php,backend/app/Services/Fiscal/CertificadoA1.php,backend/app/Services/Fiscal/DocumentoFiscalService.php,backend/app/Http/Controllers/Api/V1/DocumentoFiscalController.php,backend/app/Console/Commands/Fiscal/SequenciaDpsCommand.php,backend/config/fiscal.php,backend/config/logging.php,backend/routes/api.php,backend/database/migrations/2026_09_09_000001_create_fiscal_sequencias_table.php,frontends/desktop/app/Http/Controllers/DocumentoFiscalController.php,frontends/desktop/app/Http/Controllers/OrderController.php,frontends/desktop/app/Services/DocumentoFiscalService.php,frontends/desktop/resources/views/fiscal/nota.blade.php,frontends/desktop/resources/views/orders/closure.blade.php,frontends/desktop/routes/web.php
